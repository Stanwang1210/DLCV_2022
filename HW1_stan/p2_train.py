...
def main(args):
    ...
    transform = transforms.Compose([
        ...
        # transforms.ColorJitter(brightness=0.1, contrast=1, saturation=0.1, hue=0.1),
    ...
    # criterion = nn.CrossEntropyLoss(weight=torch.tensor([0.1, 0.1, , 0.1, 0.2, 0.1, 0.2]).to(device))
